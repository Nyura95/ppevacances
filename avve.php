    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="header-content">
                <div class="header-content-inner">
                    ...
                    <hr id="home">
                    <a class="btn btn-primary btn-xl js-scroll-trigger" href="#about2">L'expérience Village Vacances Alpes</a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        <h2 class="section-heading text-white">L'HISTOIRE</h2>
                        <hr class="light">
        ...
        <section class="bg-primary2" id="about">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        <h2 class="section-heading text-white">LA BONNE HUMEUR</h2>
                        <hr class="light">
                        <p class="text-faded">  Constituer dans chaque village une équipe compétente et accueillante, qui permette de passer des vacances en toute sérénité et garantir un accueil chaleureux et personnalisé.
        ...
        <section class="bg-primary" id="about">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        <h2 class="section-heading text-white">LES ENFANTS</h2>
                        <hr class="light">
                        <p class="text-faded">    Proposer des équipements spécialement adaptés aux bébés de 3 à 36 mois. 
        ...
        <section class="bg-primary2" id="about">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        <h2 class="section-heading text-white">LE BIEN ÊTRE</h2>
                        <hr class="light">
                        <p class="text-faded">    Rénover sans cesse nos villages, dans le cadre d’un plan de modernisation considérable.
        ...
        <section class="bg-primary" id="about">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        <h2 class="section-heading text-white"> L'EMPLOI ET LA FORMATION</h2>
                        <hr class="light">
                        <p class="text-faded">      Agir en employeur responsable, pour développer la motivation, l’implication et les compétences des équipes et garantir aux 1300 salariés de VVA de bonnes conditions de travail.
        ...
        <section class="bg-primary2" id="about">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        <h2 class="section-heading text-white">L'ECOLOGIE</h2>
                        <hr class="light">
                        <p class="text-faded">    Être une entreprise responsable dans tous les domaines et choisir des fournisseurs en fonction de leur politique salariale et de leur engagement durable. 
