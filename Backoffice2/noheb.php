                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 mx-auto text-center">
                            ...
                            <p class="text-faded"> Localisé dans <?php echo $SECTEURHEB ?> </p>

                            <hr class="light">
                            <p class="text-faded" style="text-align: left">
                            <h2 class="section-heading text-white" style="text-align:left;">  Descriptif  </h2>  
                            <p class="text-faded" style="text-align: left;">  <?php echo $DESCRIHEB ?>  </p>
                            <h2 class="section-heading text-white" style="text-align:left;">  Logement  </h2>
                            <p class="text-faded" style="text-align: left;">  Cette hébergement comporte <b> <?php echo $NBPLACEHEB ?> place(s) </b> et a une surface de <b> <?php echo $SURFACEHEB ?> m2 </b> <br>
                                    Il se situe dans<b> <?php echo $SECTEURHEB ?> </b> et est orienté coté <b>  </b> <br> 
                                 La  <b> <?php
                                        if ($INTERNET == 1) {
                        ...
                        <script>
                            ...
                            function modif()
                            {
                            alert("Le logement a bien été modifié")
                            }
                    ...
                    <form method="post" action="trtsup.php">
                        ...
                        <input class="bouton" type="submit" name="supprimer" value="Supprimer" onclick="supp()">
                         <script>
                            ...
                            function supp()
                            {
                            alert("Le logement a bien été supprimé")
                            }
