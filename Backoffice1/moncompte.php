				...
				<div class="row">
					<div class="col-lg-8 mx-auto text-center">
						...
						<div style=" color: #5472AE; border: 1px solid #5472AE; height: 521px;">
							...
							<p>  <img style="width:20%;" src="../img/image/<?php echo $PHOTOHEB ?>"> <br> Nom de l'hébergement :<?php echo $NOMHEB ?> <br> REF: <?php echo $NOHEB; ?> </p>
...
<?php endwhile; ?>
    ...
    <?php if( $_SESSION['MONCOMPTE']['TYPECOMPTE'] == 1) { ?>
      <section class="bg-primary" id="about">
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto text-center">
