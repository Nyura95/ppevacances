...
<html lang="en">
 ...
 Respecter toutes les diversités, toutes les différences, au niveau des salariés comme au niveau des villageois et travailler main dans la main avec les communes d’accueil.
            ...
            <a class="btn btn-default btn-xl js-scroll-trigger" href="avve2.php?#about2">Lire plus</a>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            ...
            <img src="../../image/panels.png"> <br> <br>
            <h2>Rechercher</h2>
            <hr>
            <br> <p> Rechercher parmis les plus belles chaînes de montagne de france l'hébergement de vos rêves. </p> </div>
              <div style="display: block; float: left; width: 27%; margin: 3%;">
                  <img src="../../image/boarding-pass.png"> <br> <br>
                  <h2> Réserver </h2>
                  <hr>
            <br> <p> Il vous suffit de réserver votre hébergement préféré selon les dates disponible. </p>
              </div>
           <div style="display: block; float: left; width: 27%; margin: 3%;">
                  <img src="../../image/suitcase.png"> <br> <br>
                  <h2> Voyager </h2>
                  <hr>
            <br> <p> Une fois la réservation terminé, vous n'avez qu'à préparer votre valise et on vous attend. A bientôt</p>
              </div>
        </div>
        <div class="row">
